const languages = {
    en: {
        ...
        mainTitle: "Chubby Cats: Seeking the Ultimate Delicacy",
        mainDescription: "Feed the cats, conquer the islands, and level up your culinary skills! In the world of Chubby Cats, these feline foodies are not just hungry—they’re picky too! Your mission is to place various island tiles, grow ingredients, cook delicious dishes, and satisfy their demands within a limited time. As you progress through levels, new challenges await, offering an addictive strategic experience!",
        gameStartButton: "Wishlist on STEAM",
        aboutTitle: "About Chubby Cats",
        ...
        getGameButton: "Add Chubby Cats to your Steam Wishlist Now",
